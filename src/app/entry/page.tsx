    ...
    <main className="min-h-dvh bg-[#f5f8f7] pb-28">
      ...
      <div className="mx-auto grid max-w-7xl gap-6 px-4 py-6 sm:px-6 lg:px-8 xl:grid-cols-[minmax(0,1fr)_420px]">
        <section className="rounded-card bg-white p-6 shadow-sm ring-1 ring-line">
          <p className="text-xs font-semibold uppercase tracking-widest text-dim">LINE Official Account</p>
          <h1 className="mt-2 font-display text-3xl font-semibold text-deep">การเข้าบ่อดำเนินผ่าน Rich Menu เท่านั้น</h1>
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-dim">
            เพื่อความปลอดภัยและป้องกันการใช้งานแทนกัน ระบบจะสร้าง QR เช็คอินจาก LINE Official Account ของสมาชิกเท่านั้น
            ข้อมูลจะผูกกับ LINE ID ที่เพิ่มเพื่อนบัญชีทางการของบ่อไว้
          </p>

          <div className="mt-6 grid gap-3 md:grid-cols-3">
            <div className="rounded-lg bg-mist p-4">
              <p className="font-semibold text-deep">1. เปิด LINE OA</p>
              <p className="mt-1 text-sm text-dim">เข้าแชท LINE Official Account ของบ่อ</p>
            </div>
            <div className="rounded-lg bg-mist p-4">
              <p className="font-semibold text-deep">2. กด “เข้าบ่อ”</p>
              <p className="mt-1 text-sm text-dim">จาก Rich Menu ช่องซ้ายบน</p>
            </div>
            <div className="rounded-lg bg-mist p-4">
        ...
        <aside className="rounded-card bg-deep p-6 text-white shadow-sm">
          ...
          <h2 className="mt-2 font-display text-2xl font-semibold">Rich Menu หลัก</h2>
